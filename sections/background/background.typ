...
The completion of the Human Genome Project @Lander2001 in 2003 enabled the development of various 'omics technologies which, as a result, facilitated the exploration of gene regulation and epigenomics. Simultaneously, genome-wide association studies (GWAS) revealed that approximately 90% of disease-associated single nucleotide polymorphisms (SNPs) are located in non-coding regions of the genome, underscoring the crucial importance of studying gene regulation and epigenomics in human health and disease for driving this biological heterogeneity @Farh2015 @French2020. This discovery catalyzed the development of many new technologies to study regulatory elements (@publication-trends). These can be broadly grouped by what they measure: some, like *DNase-seq*, *FAIRE-seq*, and *ATAC-seq*, map the landscape of open, accessible chromatin; others, like *ChIP-seq* and *CUT&TAG*, identify binding sites of specific proteins; and techniques like *Hi-C* map the genome's overall 3D architecture. These techniques are briefly described in turn.
...
Additionally, many of the above techniques have modern single-cell variants now available @Rotem2015 @Smallwood2014 @Buenrostro2015. These methods are summarized in @epigenetic-methods-overview.
