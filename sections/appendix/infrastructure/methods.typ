...
For benchmarking datasets, we used the SCREEN universe from ENCODE as the reference vocabulary and subsampled it to create vocabularies of three different sizes: 1 million, 100,000, and 10,000 regions @Sloan2016. For query datasets, we randomly downloaded ten files from ENCODE with varying numbers of genomic regions to assess performance across different query sizes and characteristics.
