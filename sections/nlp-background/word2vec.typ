...
Indeed, many methods have been developed that adapt Word2Vec-style embeddings to biological sequence data, such as DNA, RNA, and proteins @Asgari2015 @Ng2017 @Du2019. These approaches treat genes, proteins, or k-mers as "words" and biological sequences as "sentences," enabling the capture of functional and structural relationships in a continuous vector space. These methods were made possible by robust and agreed-upon vocabularies of biological sequences, such as the set of all known genes or proteins in a given organism.
